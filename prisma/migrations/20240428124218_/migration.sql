/*
  ...
  - The values [idle] on the enum `ScoreState` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "ScoreState_new" AS ENUM ('playing', 'win', 'lose');
...
ALTER TABLE "Score" ALTER COLUMN "result" SET DEFAULT 'playing';
COMMIT;
